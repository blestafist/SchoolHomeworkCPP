...
int main() {
    ...
    while (inputFile >> word) {
        ...
        size_t sizeBeforeFirst1 = word.find('1');
        if (sizeBeforeFirst1 != std::string::npos && wordSize - sizeBeforeFirst1 <= 16) {
                int decimal = std::stoi(word, nullptr, 2);

                if (biggestDecimalNum < (size_t)decimal) {
